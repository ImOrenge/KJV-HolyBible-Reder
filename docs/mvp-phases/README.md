...
- [personal-note-editor-architecture.md](./personal-note-editor-architecture.md): 개인 노트 텍스트 편집기, 구절 태그, 노트 개별 저장 구현 아키텍처.
- [personal-note-editor-phase-tasks.md](./personal-note-editor-phase-tasks.md): 성경노트 구현을 페이즈별 체크박스 태스크로 분리한 실행 체크리스트.
