...
assert.equal(buildStudyUiCommunityUrl({ tab: "feed" }), "/community");
assert.equal(buildStudyUiCommunityUrl({ tab: "participating" }), "/community");
assert.equal(buildStudyUiCommunityUrl({ tab: "ranking" }), "/community");
assert.equal(buildStudyUiCommunityUrl({ tab: "settings" }), "/community");
