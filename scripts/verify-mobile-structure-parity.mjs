...
const groups = [
  ...
  {
    name: "qt-social-community",
    labels: ["QT 커뮤니티", "추천", "팔로잉", "최신", "검색", "알림", "커뮤니티 프로필", "새 QT 나눔", "QT 나눔 수정", "인용 QT 나눔", "QT 나눔과 댓글", "답글 작성", "댓글 좋아요를 반영하지 못했습니다.", "개인 노트·하이라이트·읽기 기록은 커뮤니티에 자동 공개되거나 추천에 사용되지 않습니다.", "닉네임·아바타·호칭은 온보딩 정보와 자동으로 일치합니다.", "이전 화면", "QT 나눔 신고", "신고가 접수되었습니다.", "공개 프로필 저장", "호칭 공개 중", "뮤트", "차단"],
    absentLabels: ["내 참여", "랭킹"],
  },
  {
