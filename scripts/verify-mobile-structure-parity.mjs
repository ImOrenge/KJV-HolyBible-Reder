...
const groups = [
  ...
  },
  {
    ...
    labels: ["노트 목록 화면", "노트 편집 화면", "노트 편집기 이전 화면", "새 노트", "노트 기본 서식 도구", "노트 서식 더보기", "노트 고급 서식 도구", "노트 고급 서식 닫기", "이 기기에 임시 저장됨", "서버에 노트 저장 중", "서버에 노트 저장됨", "서버 버전과 충돌 · 내 초안 보존", "서버 버전 사용", "내 초안 유지"],
  },
    {
      name: "reader-actions",
